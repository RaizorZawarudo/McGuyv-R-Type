...
{
    std::string zonesModelCSVPath = "Source/Server/Assets/Models/Zones/Zones.csv";
    std::string spacecraftModelCSVPath = "Source/Server/Assets/Models/Spacecrafts/Spacecrafts.csv";
    std::string ennemyModelCSVPath = "Source/Server/Assets/Models/Ennemies/Ennemies.csv";
    std::string projectileCSVPath = "Source/Server/Assets/Models/Projectiles/Projectiles.csv";
    std::string mapBackgroundCSVPath = "Source/Server/Assets/BackgroundTextures/Backgrounds.csv";
    std::string obstacleCSVPath = "Source/Server/Assets/Models/Obstacles/Obstacles.csv";
    std::string explosionCSVPath = "Source/Server/Assets/Models/Explosions/Explosions.csv";
    std::string effectsCSVPath = "Source/Server/Assets/Models/Effects/Effects.csv";
    std::string powerUpCSVPath = "Source/Server/Assets/Models/PowerUps/PowerUps.csv";
    std::string iconsUICSVPath = "Source/Server/Assets/Icons/Icons.csv";
    std::string fontsCSVPath = "Source/Server/Assets/Fonts/Fonts.csv";
    std::string obstacleWavesCSVPath = "Source/Server/Assets/ObstacleWaves/obstacleWaves.csv";
    std::string ennemyWavesCSVPath = "Source/Server/Assets/EnnemyWaves/ennemyWaves.csv";
    std::string scenarioCSVPath = "Source/Server/Assets/Scenarios/Scenarios.csv";
...
{
    std::string allMapsCSVPath = "Source/Server/Maps/maps.csv";
